...
// Components
import { CsCard, CsText, AnimatedFlatList, LoadingScreen, SummaryCard, TitleAndMonths, getSchoolMonthIndex } from "@/components";

// Hooks
import { useThemedStyles, useAttendance } from "@/hooks";
...
import {
  AttendanceStatus,
  IAttendanceDTO,
} from "@/types/IAttendanceDTO";

// Styles
import { shadows, spacing, type ITheme } from "@/styles";
